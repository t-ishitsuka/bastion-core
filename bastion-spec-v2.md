...
└─────────────────────────────────────────────────────────┘
    │
    ▼
Envoy が dashboard.md を読んでユーザーに報告
    │
    ▼
ユーザー: 「次は〇〇を作って」（継続可能）
```
...
│  ・ユーザーとの唯一の対話窓口                                      │
│  ・戦略決定、タスク分解                                           │
│  ・queue/envoy_to_marshall.yaml へ指令書込                        │
│  ・dashboard.md を読んで報告                                      │
└─────────────────────────────────────────────────────────────────┘
                              │ inbox_write
                              ▼
...
│  2. System: queue/inbox/<target>.yaml に追記（sync.Mutex排他）   │
